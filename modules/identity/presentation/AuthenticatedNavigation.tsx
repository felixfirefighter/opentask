import { CalendarDays, ListTodo, Settings, Sparkles, Sprout, Sun } from "lucide-react";
...
export type AuthenticatedDestination = "today" | "tasks" | "calendar" | "habits" | "plan" | "settings";
...
const railDestinations = ["today", "tasks", "calendar", "habits", "plan"] as const;
...
export function AuthenticatedMobileNavigation({
  ...
  return (
    <nav className={styles.mobileNavigation} aria-label="Mobile navigation">
      ...
      <MobileMoreMenu
        current={
          currentDestination === "habits" || currentDestination === "settings" ? currentDestination : null
        }
      />
    </nav>
  );
