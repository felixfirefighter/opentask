export const requiredTokens = new Map(
  Object.entries({
    ...
    "--font-display":
      'var(--font-editorial, "EB Garamond"), "EB Garamond", Garamond, Georgia, "Times New Roman", serif',
    "--font-sans":
