...
Use this as the concise handoff for the implemented baseline. P7 expands it with PWA and reminder
steps only after those packages are fully integrated.
...
7. Open Settings, export the JSON file, then sign out. Confirm protected pages and export are no longer accessible.
8. Return to `/`, choose **Try demo** again, and confirm the deterministic sample workspace resets without asking for shared credentials.
