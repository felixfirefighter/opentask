...
Use this as the concise handoff for the implemented baseline. P7 expands it with Habits, Focus,
PWA, and reminder steps only after those packages are fully integrated.
...
- Habits, Focus, and reminders are part of the active plan but must not be claimed in a friend
  candidate until their complete package gates pass. Collaboration and billing remain outside active
  scope.
