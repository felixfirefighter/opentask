...
OpenTask is a calm, open-source productivity workspace that unifies capture, task organization, active calendar planning, recurring work, habits, focus sessions, and reminders. An optional AI assistant turns unstructured intent into a reviewable plan; it is not required to use the product.

The working name is not a release name. Choose and check an original final name before public submission.

## Problem

Capable personal productivity products often split useful planning features across paid tiers and proprietary services. Users who want full calendars, filters, richer reminders, statistics, and data portability either subscribe forever or assemble several disconnected tools. Self-hosters also lack an approachable, integrated option.
...
3. Connect intention to execution through habits and focus records.
4. Keep core capabilities free and data portable.
5. Use AI only when it adds leverage, with a visible proposal and explicit approval.
...
- **Open core means complete core.** There is no artificial list/task/habit/calendar limit in the application.
...
- The five demo paths in `docs/QUALITY.md` work at desktop and mobile widths.
...
No premium feature gating is part of this product plan. Hosting providers, email delivery, push delivery, and OpenAI usage can have real operating costs; self-hosters supply those resources or keys. The project must communicate that distinction honestly rather than promising cost-free infrastructure.
