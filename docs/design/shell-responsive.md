...
The rail switches product modules, not individual lists. It contains the mark/home affordance,
Today, Tasks, Calendar, Plan, Habits, and Focus. A labeled account menu at the bottom owns Settings
and Sign out.
...
- Focus: timer and recent-history context; do not create project/list navigation for Focus.
...
- More opens a labeled sheet with Matrix, Upcoming, Completed/Cancelled, Habits, Focus, settings,
  and sign out. Do not render dormant later-scope entries.
